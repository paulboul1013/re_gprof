...
**目前位於**: Phase 8 (已完成) ✅
**下一步**: Phase 5 (動態記憶體), Phase 6 (gmon.out), 或 Phase 7 (ELF 解析)

**Phase 8 完成摘要**:
- ✅ 實作 Graphviz DOT 格式輸出
- ✅ 支援 per-thread 和 merged 兩種視覺化模式
- ✅ 顏色編碼標示熱點函數 (紅色=hot, 藍色=cold)
- ✅ 顯示呼叫次數、執行緒數、百分比
- ✅ 成功產生 PNG 圖片 (callgraph_merged.png, callgraph_per_thread.png)
